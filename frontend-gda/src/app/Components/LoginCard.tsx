...
export default function LoginCard(){
    return(
        <div className="bg-white/10 backdrop-blur-[4px] border-white border-1 w-[70vh] h-[50vh] flex flex-col rounded-2xl">
